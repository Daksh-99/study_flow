...
export const CourseGridView = () => {
  ...
  const getinstrutor = () => {
    for (let index = 0; index < ins?.length; index++) {
      // console.log("WOWO ", ins[index]);
      if(index <= data?.length - 1){
        // console.log("MOMO: ", data[index]?.instructor[0]);
      }
    }
  }
    useEffect(() => {
              ...
              <div className="course-card-body">
                <Stack direction="column" spacing={2}>
                  ...
                  <Stack direction="row" justifyContent="space-between" sx={{ paddingX: '2.5%'}}>
                    ...
                    <div className="course-price">12 Months</div>
                  </Stack>
                  <Divider />
                  <Stack direction="row" justifyContent="space-between" sx={{ paddingX: '2.5%'}}>
                    <div className="course-date">Educators:</div>
                    <div className="course-price">{course.instructor}</div>
                  </Stack>
                  <Divider />
                  <Stack direction="row" justifyContent="space-between" sx={{ paddingX: '2.5%'}}>
